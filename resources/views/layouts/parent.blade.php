...
/*
	.elementor-6 .elementor-element.elementor-element-3271c67f {
		background-image: url('/images/client/slider.jpg') !important;
	}*/
    </style>
    <link rel='stylesheet' id='airi-bootstrap-css' href='/client/bootstrap.min.css?ver=1' type='text/css' media='all' />
    <link rel='stylesheet' id='contact-form-7-css' href='/client/styles.css?ver=5.0.2' type='text/css' media='all' />
    <link rel='stylesheet' id='airi-style-css' href='/client/style.css?ver=4.9.8' type='text/css' media='all' />
    <link rel='stylesheet' id='airi-font-awesome-css' href='https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css' type='text/css' media='all' />
    <link rel='stylesheet' id='elementor-icons-css' href='/client/elementor-icons.min.css?ver=3.8.0' type='text/css' media='all' />
    ...
    .atu-logistics-contact input:not(.wpcf7-submit),
    .atu-logistics-contact textarea {
        padding-top: 11px;
        padding-bottom: 11px;
        width: 100%;
    }
...
<p><span style="color: #bfbfbf;">Phone:</span> (+44) 7969 232002</p>
<p><span style="color: #bfbfbf;">Address:</span> 25 Canal St., New York</p>
</div>
		</section>				</div>

							<div class="sidebar-column col-md-3">
					<section id="nav_menu-2" class="widget widget_nav_menu"><h3 class="widget-title">Quick links</h3><div class="menu-quick-links-container"><ul id="menu-quick-links" class="menu"><li id="menu-item-174" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-174"><a href="#">About us</a></li>
...
<li id="menu-item-180" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-180"><a href="https://linkedin.com"><span class="screen-reader-text">Linkedin</span></a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="site-info col-md-12">
                        <a href="/">&copy; copyright. BBSule</a>
                         </div><!-- .site-info -->
                </div>
            </div>
        </footer><!-- #colophon -->
    ...
    <script type='text/javascript' src='https://mk0athemesdemon3j7s5.kinstacdn.com/wp-includes/js/wp-embed.min.js?ver=4.9.8'></script>
    ...
    <script type='text/javascript' src='https://mk0athemesdemon3j7s5.kinstacdn.com/wp-content/plugins/elementor/assets/lib/jquery-numerator/jquery-numerator.min.js?ver=0.2.1'></script>
